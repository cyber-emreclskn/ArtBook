...
import com.emrecaliskan.artbook.databinding.RecycleRowBinding;

import java.util.ArrayList;

public class ArtAdepter extends RecyclerView.Adapter<ArtAdepter.ArtHolder> {

    ArrayList<Art> artArrayList;

    public ArtAdepter(ArrayList<Art> artArrayList){
    ...
    public void onBindViewHolder(@NonNull ArtHolder holder, int position) {
        holder.binding.recycleViewTextView.setText(artArrayList.get(position).getArtname());
